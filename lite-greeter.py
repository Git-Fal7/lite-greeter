...
UI_FILE_LOCATION = "/usr/local/share/lite-greeter/main.ui"

# read the cache
cache_dir = (Path.home() / ".cache" / "lite-greeter")
...
def read_config(gtk_settings, config_file="/etc/lightdm/lite-greeter.conf"):
